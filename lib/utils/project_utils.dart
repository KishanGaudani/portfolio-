class ProjectUtils {
  static const List<String> banners = [
    ...
    "assets/projects/rating app.png",
  ...
  static const List<String> titles = [
    ...
    "By Lord krishna on life and success",
    "MedKit",
    "Here I Am",
    "COVID-19",
  ...
  static const List<String> description = [
    ...
    "Application of Holy book of hindu, Bhagwad gita. Developed using Flutter. Powered with live RestAPI given in README.md",
